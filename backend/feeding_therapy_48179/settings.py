"""
Django settings for feeding_therapy_48179 project.
...
ROOT_URLCONF = 'feeding_therapy_48179.urls'
...
WSGI_APPLICATION = 'feeding_therapy_48179.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "feeding_therapy_48179 API",
    "DESCRIPTION": "API documentation for feeding_therapy_48179 App",
    "VERSION": "v1",
}
